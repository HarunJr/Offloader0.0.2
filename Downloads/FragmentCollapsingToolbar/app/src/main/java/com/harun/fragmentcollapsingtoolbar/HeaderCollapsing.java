 ...
 */
public class HeaderCollapsing extends CoordinatorLayout.Behavior<HeaderView> {
    ...
    public HeaderCollapsing(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public HeaderCollapsing(Context context, AttributeSet attrs, Context mContext) {
        super(context, attrs);
