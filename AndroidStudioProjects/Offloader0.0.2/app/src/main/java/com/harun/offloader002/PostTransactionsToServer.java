...
/**
 * Created by HARUN on 4/9/2016.
 */
public class PostTransactionsToServer extends AsyncTask<String, Void, String> {
    public static final String LOG_TAG = PostVehiclesToServerTask.class.getSimpleName();
    Context mContext;

    public PostTransactionsToServer(Context context) {
    ...
    protected String doInBackground(String... params) {
        ...
        String post_url = "http://192.168.245.1/Offloader002/transact.php";/**specific to genymotion IPV4 address**/
///        String post_url = "http://10.0.2.2/Offloader002/input.php";/**specific to android virtual device**/
        ...
        if (method.equals("transact")) {
            ...
            try {
                ...
                Log.w(LOG_TAG, "doInBackground called "+ vehicleId +": "+dateTime);
