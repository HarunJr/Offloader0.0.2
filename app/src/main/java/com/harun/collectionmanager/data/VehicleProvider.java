...
import static com.harun.collectionmanager.data.VehicleContract.*;

/**
 * Created by HARUN on 7/20/2015.
 */
public class VehicleProvider extends ContentProvider {

    private static final String LOG_TAG = VehicleProvider.class.getSimpleName();
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            ...
            case VEHICLES: {
                long _id = db.insert(VehicleEntry.TABLE_NAME, null, values);
                if (_id > 0)
